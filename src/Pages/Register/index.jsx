            ...
            <div className="card shadow-md w-[400px] m-auto rounded-md bg-white p-5 px-10">
                ...
                <form className='w-full mt-5'>
                    <div className='form-group w-full mb-5'>
                        <TextField type= "text" id="name" label="Full Name" variant="outlined" className='w-full' required/>
                    </div>
                     <div className='form-group w-full mb-5'>
                        <TextField type= "email" id="email" label="Email Id" variant="outlined" className='w-full' required/>
                    </div>
                    <div className='form-group w-full mb-5 relative'>
                        <TextField type= {isShowPassword===false ? "password" : "text"} id="password" label="Password" variant="outlined" className='w-full' required/>
                    ...
                    <div className='form-group w-full mb-5 relative'>
                        <TextField type= {isShowPassword===false ? "password" : "text"} id="password" label="Confirm Password" variant="outlined" className='w-full' required/>
                        <Button className='!absolute top-[7px] right-[10px] z-50 !w-[35px] !h-[35px] !min-w-[35px] !rounded-full !text-black'
                          onClick={()=>setIsShowPassword (!isShowPassword)}>
                            {
                                isShowPassword===false ? <MdOutlineVisibility className='text-[20px] opacity-75'/> : <MdOutlineVisibilityOff className='text-[20px] opacity-75'/> 
