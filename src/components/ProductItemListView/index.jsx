...
const ProductItem = () => {
  ...
  return (
    <div className="productsSlider py-5 w-full max-w-screen-xl mx-auto">
      <div className=" border-1 border-[rgba(0,0,0,0.1)] rounded-lg shadow-md p-2 w-full flex items-center">
        <div className="group relative">
          ...
          <span className="discount flex item-center absolute top-[10px] left-[10px] z-50 bg-[#ff5252] text-white text-xs px-2 py-1 rounded-full">
            10%
          </span>
        ...
        <div className="p-3 info py-5 px-8 w-[75%]">
          <h6 className="text-[15px] !font-[400]">
            <Link to="/" className="link transition-all">
              HP branded laptop
            </Link>
          </h6>
          <h2 className="font-semibold text-[20px] title mt-3 mb-3 text-[rgba(0,0,0,0.9)]">
            <Link to="/" className="link transition-all text-[(#000)]">
              HP Laptop
            </Link>
          </h2>
          <p className="text-[14px] mb-3">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nulla qui
            est illo saepe incidunt voluptate voluptatibus debitis totam. Ad, id
            suscipit expedita culpa, consectetur nulla quas ducimus, sapiente
            esse necessitatibus fuga nobis.
          </p>
          ...
          <div className="flex items-center gap-4">
            <span className="oldPrice text-gray-500 text-[16px] font-bold line-through">
              $180.00
            </span>
          ...
          <div className="mt-3">
            <Button className="btn-org mt-3 flex gap-2"><CgShoppingCart className="text-[20px]"/>Add to Cart</Button>
          </div>
